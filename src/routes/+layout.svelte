...
<svelte:head
	...
	<meta
		name="description"
		content="i'm jack, a fullstack developer from the åland islands.
...
<div class="grid min-h-dvh place-items-center gap-2">
	<div class="m-2 flex flex-col gap-2 lg:w-xl">
		{@render children()}
	</div>
</div>
